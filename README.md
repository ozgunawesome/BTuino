...
Arduino IDE uses it to upload sketches to the board. (see the following instructions for MacOS: https://community.st.com/t5/stm32cubeprogrammer-mcu/how-to-run-stm32cubeprogrammer-on-macos-catalina-10-15-1-19b88/td-p/307576
